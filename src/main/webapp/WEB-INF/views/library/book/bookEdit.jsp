...
<div id="pageBody">
    ...
    <form id="bookEditForm" action="/library/book/bookEdit/bookEditOk" method="post" modelAttribute="bookEditOk">
        <div class="detailBox">
        ...
        <input type="hidden" name="bookNum" value="${bookEdit.bookNum}"/>
        <div class="btnBox2">
